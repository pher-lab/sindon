...
- **✅ FW-17 [fw] P3 🧷 — Input/SecureInput の padding・高さが非公開(G3)= 完了 (2026-07-02, 実機 OK)**
  ...
  - 将来: G4 は Input/SecureInput 側は `padding_x/y` で非対称化できたが **Container の非対称 padding は未**(`padding_trbl` は内部 API、公開 builder 無し)。G6 Button 寸法 / G12 Input weight / G16 Dropdown・MenuItem は FW-18 系候補として残置。
