...
impl FlexStyle {
    ...
    /// full range (`Start` / `End` / `SpaceBetween` / …). Maps the sindon
...
///
/// The sindon-native counterpart to Taffy's `JustifyContent`, so widgets can
...
///
/// The sindon-native counterpart to Taffy's `AlignItems`; the general form of
