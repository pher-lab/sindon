...
pub struct DrawGlyph {
    ...
    pub cache_key: sindon_text::CacheKey,
...
pub struct Renderer {
    ...
    // pixels (the GPU knows nothing else), but everything sindon hands the
...
impl Renderer {
    pub async fn new(window: Arc<Window>) -> Self {
        ...
        let rect_shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("sindon_rect_shader"),
            source: wgpu::ShaderSource::Wgsl(RECT_SHADER.into()),
        });

        let rect_pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("sindon_rect_pipeline_layout"),
            bind_group_layouts: &[],
            immediate_size: 0,
        });

        let rect_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            label: Some("sindon_rect_pipeline"),
        ...
        let text_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("sindon_text_bind_group_layout"),
                entries: &[
        ...
        let sampler = device.create_sampler(&wgpu::SamplerDescriptor {
            label: Some("sindon_text_sampler"),
        ...
        let text_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("sindon_text_bind_group"),
        ...
        let color_text_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("sindon_color_text_bind_group"),
            layout: &text_bind_group_layout,
            entries: &[
                wgpu::BindGroupEntry {
                    binding: 0,
        ...
        let secure_text_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("sindon_secure_text_bind_group"),
            layout: &text_bind_group_layout,
            entries: &[
                wgpu::BindGroupEntry {
                    binding: 0,
        ...
        let text_shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("sindon_text_shader"),
            source: wgpu::ShaderSource::Wgsl(TEXT_SHADER.into()),
        });

        let text_pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("sindon_text_pipeline_layout"),
            bind_group_layouts: &[Some(&text_bind_group_layout)],
            immediate_size: 0,
        });

        let text_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            label: Some("sindon_text_pipeline"),
        ...
        let image_shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("sindon_image_shader"),
            source: wgpu::ShaderSource::Wgsl(IMAGE_SHADER.into()),
        });

        let image_pipeline_layout =
            device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                label: Some("sindon_image_pipeline_layout"),
                bind_group_layouts: &[Some(&text_bind_group_layout)],
                immediate_size: 0,
            });

        let image_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            label: Some("sindon_image_pipeline"),
    ...
    fn ensure_image_uploaded(&mut self, image: &DecodedImage) {
        ...
        let texture = self.device.create_texture(&wgpu::TextureDescriptor {
            label: Some("sindon_image_texture"),
            size: extent,
        ...
        let bind_group = self.device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("sindon_image_bind_group"),
            layout: &self.text_bind_group_layout,
            entries: &[
                wgpu::BindGroupEntry {
                    binding: 0,
    ...
    pub fn render(
        ...
        let mut encoder = self
            ...
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("sindon_render_encoder"),
            });

        {
            let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
                label: Some("sindon_render_pass"),
    ...
    /// encoder until some later frame happened to be drawn — and sindon
