...
//!   [`shroud_reactive::animation::request_frame_at`] for the next toggle
...
//!   wakes. `shroud_app` publishes the platform value at startup via
...
/// Called by `shroud_app`; apps use [`set_caret_blink`] instead.
