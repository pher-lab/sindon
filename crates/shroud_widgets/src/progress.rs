...
//! [`request_frame`](shroud_reactive::animation::request_frame), exactly as
//! [`Animated`](shroud_reactive::animation::Animated) does while in flight. That
...
use shroud_reactive::animation::{self, request_frame};
...
impl ProgressBar {
    ...
    ///
    /// [`Signal<f32>`]: shroud_reactive::Signal
