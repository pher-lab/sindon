...
//! # Accessibility
//!
//! The host reports itself as a [`Tree`](sindon_core::AccessRole::Tree) and each
//! row as a [`TreeItem`](sindon_core::AccessRole::TreeItem) carrying its label,
...
use sindon_core::{AccessAction, AccessNode, AccessRole, Color, Rect};
...
mod tests {
    ...
    fn down(x: f32) -> WidgetEvent {
        WidgetEvent::MouseDown {
            button: MouseButton::Left,
            position: sindon_core::Point::new(x, 12.0),
        }
    }
