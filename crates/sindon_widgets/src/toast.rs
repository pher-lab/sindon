...
//!
//! [`request_frame`]: sindon_reactive::animation::request_frame
//! [`request_frame_at`]: sindon_reactive::animation::request_frame_at
...
use sindon_core::{Color, Rect, Size};
use sindon_layout::FlexStyle;
use sindon_reactive::animation::{self, request_frame, request_frame_at};
use sindon_text::TextAttrs;
...
/// clear of the card's rounded corners (sindon rounds all four corners
...
impl ToastKind {
    ...
    fn accent(self, theme: &sindon_core::Theme) -> Color {
        match self {
