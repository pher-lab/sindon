...
use sindon_core::{AccessAction, AccessChild, AccessNode, Rect, SecurityLevel, Size, Theme};
...
pub trait Widget: std::any::Any {
    ...
    /// [`Group`](sindon_core::AccessRole::Group) so its bounds and children
    ...
    /// [`protected`](sindon_core::AccessNode::protected) node and never place
    ...
    ///
    /// [`Focus`](sindon_core::AccessAction::Focus) never arrives here — the
