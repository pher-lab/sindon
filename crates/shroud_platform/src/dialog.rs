...
//!
//! ```no_run
//! use shroud_platform::dialog::FileDialog;
//!
//! # let window: &shroud_platform::PlatformWindow = unimplemented!();
...
impl FileDialog {
    ...
    /// Attach the dialog to the shroud window so it appears modal.
    ///
